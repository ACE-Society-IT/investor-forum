      ...
      <div className="vercel-card rounded-2xl p-4 sm:p-5 font-mono border-l-4 border-l-[#4a151b] dark:border-l-[#541c21] shadow-lg bg-gradient-to-r from-[var(--surface-1)] via-[var(--surface-2)] to-[var(--surface-1)]">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-[#4a151b]/15 dark:bg-[#541c21]/30 text-[#4a151b] dark:text-[#d8a4a7] flex items-center justify-center shrink-0 shadow-[0_0_0_1px_rgba(110,42,48,0.4)]">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="px-2 py-0.5 rounded text-[10px] font-bold bg-[#4a151b]/15 dark:bg-[#541c21]/30 text-[#4a151b] dark:text-[#d8a4a7] shadow-[0_0_0_1px_rgba(110,42,48,0.4)]">
